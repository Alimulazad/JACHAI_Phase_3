            ...
            >
              ...
              >
                <Icon
                  className={`w-5 h-5 transition-all duration-200 ${
                    isActive
                      ? 'stroke-[2.5px] text-[#0F766E] dark:text-emerald-400 drop-shadow-xs'
                      : 'stroke-[1.8px]'
                  }`}
                />
              ...
              <span
                className={`text-[11px] mt-1 tracking-tight transition-all duration-150 ${
                  isActive
                    ? 'font-bold text-[#0F766E] dark:text-emerald-400'
              ...
              {isActive && (
                <motion.div
                  ...
                  className="w-1.5 h-1.5 bg-[#0F766E] dark:bg-emerald-400 rounded-full mt-0.5"
