...
export const KnowledgeCarousel: React.FC = () => {
  ...
  return (
    <div
      ...
      className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#0F766E] via-[#0D9488] to-[#047857] text-white p-4 sm:p-5 shadow-sm border border-emerald-900/30 min-h-[170px] flex flex-col justify-between select-none"
    >
      {/* Decorative background glow */}
      <div className="absolute -top-10 -right-10 w-44 h-44 bg-emerald-300/20 rounded-full blur-2xl pointer-events-none" />
      <div className="absolute -bottom-8 -left-8 w-36 h-36 bg-teal-300/20 rounded-full blur-xl pointer-events-none" />
      ...
      <div className="relative z-10 flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-emerald-200/80 font-mono font-semibold">
