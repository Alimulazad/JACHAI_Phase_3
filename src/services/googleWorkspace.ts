...
• প্রস্তুতি ট্র্যাক করুন: চর্চা Varsity AI অ্যাপ`,
...
• নো-ক্যালকুলেটর শর্টকাট ও ট্রিকস চর্চা করুন চর্চা AI অ্যাপে`,
...
• মক টেস্ট দিন: চর্চা AI প্র্যাকটিস প্ল্যাটফর্ম`,
...
• সময়: ৬০ মিনিট
• চর্চা AI স্পেশাল মক টেস্ট সম্পন্ন করুন।`,
...
export const createKeepNotePayload = (
  ...
  const formattedText = `${title}\n\n${content}\n\n— সংরক্ষিত চর্চা AI এডমিশন মেন্টর থেকে`;
